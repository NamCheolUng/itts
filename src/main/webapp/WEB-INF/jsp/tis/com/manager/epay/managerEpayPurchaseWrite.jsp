...
<script>
	...
	function btn_submit(){
		...
		if(confirm('수정 하시겠습니까?')) {
			f.action = "<c:url value='/com/manager/epay/managerEpayPurchaseWriteUpdate.do'/>";
			f.submit();
		}
	}
...
<form name="frm" method="post">
	...
	<div id="subwrap">
		...
		<h4>
			<i class="fas fa-dot-circle"></i>매입 수정
		</h4>
		(*) 필수입력항목
			...
			<tbody>
				<tr>
					...
					<td>
						...
						<input type="hidden" name="adbkId" value="${purchaseVO.adbkId}">
		...
		<div class="btngroup fr">
			...
			<button type="button" class="btn02" onclick="javascript:fn_requestManagerCnsulView();">취소</button>
		</div>
	</div>
</form>
