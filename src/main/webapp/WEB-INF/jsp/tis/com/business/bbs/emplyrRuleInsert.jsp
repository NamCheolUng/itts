...
function fn_goto_save(){
	...
	document.frm.action = "<c:url value='/com/business/bbs/emplyrRuleSave.do'/>";
	document.frm.submit();
	writeTp = true;
}
...
<div id="subwrap">
	...
	<div class="btngroup fr">
		...
		<button type="button" class="btn01" onClick="javascript:fn_goto_save();">저장</button>	
	</div>
</div>
</form:form>
