...
<script>
    ...
    function fn_GotoUpdate(){
    	...
    	document.subForm.action = "<c:url value='/com/financial/bankBook/cardUpdate.do?affiliationId=I'/>";
    	document.subForm.submit();
    }
    
    function fn_GotoView(){
    	document.subForm.action = "<c:url value='/com/financial/bankBook/cardView.do?affiliationId=I'/>";
    	document.subForm.submit();
    }
</script>
