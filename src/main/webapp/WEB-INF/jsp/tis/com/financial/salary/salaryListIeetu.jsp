...
$(document).ready(function() {
    ...
    $("#selectListCnt").change(function(){
    	document.frm.pageIndex.value = 1;
      	document.frm.action = "<c:url value='${tmpPath}/com/financial/salary/salaryList.do?affiliationId=I'/>";
    	document.frm.submit();
    })
});
...
function fn_goSalaryDetail(ymonth, affiliationId){
	document.frm.ymonth.value = ymonth;
  	...
  	document.frm.action = "<c:url value='/com/financial/salary/salaryDetail.do?affiliationId=I'/>";
	document.frm.submit();
}
...
function fn_insertExcel()
{
	...
	{
   		document.frm.action = "<c:url value='/com/financial/salary/salaryExcelUpload.do?affiliationId=I'/>";
		document.frm.submit();
	}
}
...
function fn_downloadExcel()
{
	...
	$("input[name=box]:checked").each(function() {
		...
		document.frm.action = "<c:url value='/com/financial/salary/downloadExcel.do?affiliationId=I'/>";
		document.frm.submit();
}
