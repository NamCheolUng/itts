    ...
    <script>
        $(function() {
            ...
            var dataSource = new kendo.data.DataSource({
                ...
                transport: {
                    read:  {
                    	url: "<c:url value='/com/financial/nonOperProfit/loadExcelData.do'/>?affiliationId=S",
                        dataType: "jsonp"
                    },
                    update: {
                    	contentType: "application/json; charset=utf-8",
                    	url: "<c:url value='/com/financial/nonOperProfit/updtExcelData.do'/>?affiliationId=S",
                        dataType: "jsonp",
                    },
                     destroy: {
                    	 url: "<c:url value='/com/financial/nonOperProfit/deleteExcelData.do'/>?affiliationId=S",
                        dataType: "jsonp"
                    },
                    create: {
                    	url: "<c:url value='/com/financial/nonOperProfit/insertExcelData.do'/>?affiliationId=S",
                        dataType: "jsonp"
                    },
