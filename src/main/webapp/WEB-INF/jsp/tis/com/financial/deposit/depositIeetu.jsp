    ...
    <script>
        $(function() {
            ...
            var dataSource = new kendo.data.DataSource({
                    ...
                    setTimeout(function(e) {
                      if(shouldPopulateHeader) {
                        ...
                        sheet.batch(function(){
                          ...
                          sheet.range("D2:D100").format('#,###');
                          sheet.range("E2:E100").format('#,###');
                ...
                transport: {
                    read:  {
                    	url: "<c:url value='/com/financial/deposit/loadExcelData.do'/>?affiliationId=I",
                        dataType: "jsonp"
                    },
                    update: {
                    	contentType: "application/json; charset=utf-8",
                    	url: "<c:url value='/com/financial/deposit/updtExcelData.do'/>?affiliationId=I",
                        dataType: "jsonp",
                    },
                     destroy: {
                    	 url: "<c:url value='/com/financial/deposit/deleteExcelData.do'/>?affiliationId=I",
                        dataType: "jsonp"
                    },
                    create: {
                    	url: "<c:url value='/com/financial/deposit/insertExcelData.do'/>?affiliationId=I",
                        dataType: "jsonp"
                    },
