...
$(document).ready(function() {
    ...
    $("#selectListCnt").change(function(){
    	document.frm.pageIndex.value = 1;
      	document.frm.action = "<c:url value='${tmpPath}/com/financial/salary/salaryDetailEmplyr.do?affili=S'/>";
    	document.frm.submit();
    })
});
...
function downloadExcel(){
	...
	$("input[name=box]:checked").each(function() {
		...
		document.frm.action = "<c:url value='/com/financial/salary/downloadDetailEmplExcel.do?affiliationId=S'/>";
		document.frm.submit();
}
