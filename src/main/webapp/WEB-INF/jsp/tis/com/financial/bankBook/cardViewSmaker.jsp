...
function fn_GotoModify( ){
	document.subForm.action = "<c:url value='/com/financial/bankBook/cardModify.do?affiliationId=S'/>";
...
function fn_GotoDelete(){
	if(confirm("삭제 하시겠습니까?") == false)
		return;
	document.subForm.action = "<c:url value='/com/financial/bankBook/cardDelete.do?affiliationId=S'/>";
	document.subForm.submit();
