...
function fn_GotoModify(){
	document.subForm.action = "<c:url value='/com/financial/bankBook/bankBookModify.do?affiliationId=S'/>";
...
function fn_GotoDelete(){
	if(confirm("삭제 하시겠습니까?") == false)
		return;
	document.subForm.action = "<c:url value='/com/financial/bankBook/bankBookDelete.do?affiliationId=S'/>";
	document.subForm.submit();
}
