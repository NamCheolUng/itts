...
<div id="subwrap">
	...
	<div class="tabmenu">
		<ul>
			<li class="active"><a href="<c:url value='/com/financial/periodicSettle/expense.do?affiliationId=I'/>">지출</a></li>
			<li><a href="<c:url value='/com/financial/periodicSettle/profit.do?affiliationId=I'/>">수입</a></li>
		</ul>
	</div>
	<br><br><br><br>
    ...
    <script>
        $(function() {
            ...
            var dataSource = new kendo.data.DataSource({
                ...
                transport: {
                    read:  {
                    	url: "<c:url value='/com/financial/periodicSettle/loadExcelData.do'/>?affiliationId=I&typeAt=E",
                        dataType: "jsonp"
                    },
                    update: {
                    	contentType: "application/json; charset=utf-8",
                    	url: "<c:url value='/com/financial/periodicSettle/updtExcelData.do'/>?affiliationId=I&typeAt=E",
                        dataType: "jsonp",
                    },
                     destroy: {
                    	 url: "<c:url value='/com/financial/periodicSettle/deleteExcelData.do'/>?affiliationId=I&typeAt=E",
                        dataType: "jsonp"
                    },
                    create: {
                    	url: "<c:url value='/com/financial/periodicSettle/insertExcelData.do'/>?affiliationId=I&typeAt=E",
                        dataType: "jsonp"
                    },
