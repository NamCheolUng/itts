...
<script>
		...
		$.ajax({
					...
					success : function(data) {
						if (data == 1) {
							...
							document.frm.action = "<c:url value='/com/financial/laterSettle/addparkingExpense.do?affiliationId=I'/>";
							document.frm.submit();
						}
					},
	...
	function fn_updtParkingList() {
		...
		$.ajax({
					...
					contentType : 'application/x-www-form-urlencoded; charset=UTF-8',
					success : function() {
						location.href = "<c:url value='/com/financial/laterSettle/parkingExpense.do?affiliationId=I'/>"
					},
					error : function() {
						location.href = "<c:url value='/com/financial/laterSettle/parkingExpense.do?affiliationId=I'/>"
					}
	...
	function fn_downloadExcel() {
		...
		document.frm.action = "<c:url value='/com/financial/laterSettle/parkingDownloadExcel.do?affiliationId=I'/>";
		document.frm.submit();
	}
</script>
<div id="subwrap">
	<form name="frm" method="post">
		...
		<input type="hidden" name="extensionDt"> <input type="hidden" name="emplNm">
		...
		<div class="tabmenu">
			<ul>
				<li><a href="<c:url value='/com/financial/laterSettle/foodExpense.do?affiliationId=I'/>">중식비</a></li>
				<li class="active"><a href="<c:url value='/com/financial/laterSettle/parkingExpense.do?affiliationId=I'/>">주차정기권</a></li>
			</ul>
		</div>
		<br><br><br>
	...
	<form name="frm2" id="frm2" method="post">
		...
		<div class="btngroup fr">
			...
			<input type="hidden" name="returnUrl" value="<c:url value='${tmpPath}com/financial/laterSettle/parkingExpense.do?affiliationId=I'/>">
		</div>
		<div id="divLoader">
