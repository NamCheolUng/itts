...
/* 	$(document).ready(function(){
	...
	function fn_save(){		
		...
		document.subForm.action="<c:url value='/com/task/taskInsert.do'/>";
		...
		<table class="tablewrite">
			...
			<tbody>
				<tr>
					<th>과제명</th>
					<td colspan="3">
						<input type="text" class="k-textbox width100p" name="taskNm">
				...
				<tr>
					<th>발주처</th>
					<td>
						<input type="text" class="k-textbox width100p" id="companyNm" readonly="readonly">
						<input type="hidden" name="adbkId">
						<button type="button" class="btn03" onclick="javascript:fn_companyListPopup();">찾기</button>
					</td>
					<th>사업기간</th>
					<td>
						<input class="datepicker width200" name="taskSdate" id="taskSdate" placeholder="시행일자" title="시행일자">~
						<input class="datepicker width200" name="taskEdate" id="taskEdate" placeholder="시행일자" title="시행일자">
					</td>
				</tr>						
				<tr>
					<th>사업범위</th>
					<td colspan="3"><textarea class="k-textbox width100p height300" name="chargerNm"></textarea></td>
				</tr>
				<tr>
					<th>주요키워드</th>
					<td colspan="3"><input type="text" class="k-textbox width100p" name="keyword"></td>
				</tr>
				<tr>
					<th>과제진행상태</th>
					<td colspan="3">
						<label for="radio01">진행전</label><input type="radio" id="radio01" class="" value="01" name="taskStatusCd" checked="checked">
						<label for="radio02">진행중</label><input type="radio" id="radio02" class="" value="02" name="taskStatusCd">
						<label for="radio03">완료</label><input type="radio" id="radio03" class=""  value="03" name="taskStatusCd">
						<label for="radio04">지연</label><input type="radio" id="radio04" class=""  value="04" name="taskStatusCd">
						<label for="radio05">지연완료</label><input type="radio" id="radio05" class="" value="05" name="taskStatusCd">
						<label for="radio06">중단</label><input type="radio" id="radio06" class="" value="06" name="taskStatusCd">
					</td>
				</tr>
				<tr>
				    <th>과제공유설정</th>
					<td colspan="3">
						<label for="radio07">공개</label><input type="radio" id="radio07" class="" value="Y" name="commonAt" checked="checked">
						<label for="radio08">비공개</label><input type="radio" id="radio08" class="" value="N" name="commonAt">
					</td>
				</tr>
				<tr>
				    <th>관련과제</th>
					...
					<td colspan="3">
						<select class="select width150" name="mainDept">
							...
							<c:forEach var="dept" items="${deptCodeList }" varStatus="status">
								<option value="<c:out value='${dept.code }'/>"><c:out value='${dept.codeNm }'/></option>
							</c:forEach>
						</select>
					</td>
				</tr>			
