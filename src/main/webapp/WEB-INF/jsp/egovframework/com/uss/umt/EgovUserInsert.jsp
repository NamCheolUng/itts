...
function setEmail(em) {
	...
	function fn_GotoWrite() {
		...
		if(document.subForm.phone1.value != "" && document.subForm.phone2.value != ""){
 		...
 		document.subForm.action = "<c:url value='/uss/umt/EgovUserInsert.do'/>";
...
<div id="mainwrap">
	<form name="subForm" method="post" enctype="multipart/form-data">
			...
			<tbody>
				...
				<tr>
					...
					<td><input type="hidden" name="emplyrBngde"> 
						<input type="date" name="emplyrBngde1" class="datepicker width200"></td>
				...
				<tr>
					<th>권한</th>
					<td><select name="manageAt" class="select width150">
		...
		<div class="btngroup fr">
			<button type="button" class="btn02" onclick="location.href='<c:url value='/uss/umt/EgovUserManage.do'/>' ">취소</button>
