...
public class UserManageController {
	 ...
	 * @param model 화면모델
	 * @return cmm/com/member/EgovUserManage
	 * @throws Exception
	 */
	@IncludedInfo(name = "업무사용자관리", order = 460, gid = 50)
	@RequestMapping(value = "/com/member/EgovUserManage.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/com/member/EgovUserInsertView.do")
...
*/
		...
		return "tis/com/member/EgovUserInsert";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/com/member/EgovUserInsert.do")
	public String insertUser(@ModelAttribute("userManageVO") UserManageVO userManageVO, BindingResult bindingResult, Model model,
		...
		return "redirect:/com/member/EgovUserManage.do";
	}
	...
	/*사용자 상세조회*/
	@RequestMapping("/com/member/EgovUserSelectView.do")
	public String EgovUserSelectView(@ModelAttribute("userManageVO") UserManageVO userManageVO, Model model, HttpServletRequest request ) throws Exception {
		...
		model.addAttribute("depart_result", depart_result); //부서구분
		model.addAttribute("postion_result", postion_result); //직위구분
		return "tis/com/member/EgovUserSelect";
	}
...
/*		if(userManageVO.equals(null)){
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/com/member/EgovUserSelectUpdt.do")
...
/*		if(!userManageVO.getManageAt().equals("Y")){
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/com/member/EgovUserDelete.do")
