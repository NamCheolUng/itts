...
public class IndvdlSchdulManageDao extends EgovComAbstractDAO {
	...
	public EgovMap selectIndvdlSchdulManageDetailEgovMap(IndvdlSchdulManageVO indvdlSchdulManageVO) throws Exception{
		return (EgovMap)select("IndvdlSchdulManage.selectIndvdlSchdulManageDetailVO", indvdlSchdulManageVO);
	}
	...
	public void insertRelatedCmng(IndvdlSchdulManageVO indvdlSchdulManageVO) throws Exception{
		insert("IndvdlSchdulManage.insertRelatedCmng",indvdlSchdulManageVO);
	}
	
	public void deleteRelatedCmng(IndvdlSchdulManageVO indvdlSchdulManageVO) throws Exception{
		delete("IndvdlSchdulManage.deleteRelatedCmng",indvdlSchdulManageVO);
	}
	
	public List<?> selectRelatedCmng(IndvdlSchdulManageVO indvdlSchdulManageVO) throws Exception{
		return list("IndvdlSchdulManage.selectRelatedCmng",indvdlSchdulManageVO);
	}
}
