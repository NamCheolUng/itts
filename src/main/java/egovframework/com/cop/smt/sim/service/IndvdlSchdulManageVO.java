...
public class IndvdlSchdulManageVO implements Serializable {
	...
	private String schdulSdt;
	
	private String schdulEdt;
	
	private String schdulPrgrs;
	
	private String schdulPrgrsSttus;
	
	private String schdulFinDt;
	
	private String schdulLateReson;
	
	private String schdulType;
	
	private int schdulTime;
	
	private int schdulEarlydelayTime;
	...
	public String getSchdulSdt() {
		return schdulSdt;
	}

	public void setSchdulSdt(String schdulSdt) {
		this.schdulSdt = schdulSdt;
	}

	public String getSchdulEdt() {
		return schdulEdt;
	}

	public void setSchdulEdt(String schdulEdt) {
		this.schdulEdt = schdulEdt;
	}

	public String getSchdulPrgrs() {
		return schdulPrgrs;
	}

	public void setSchdulPrgrs(String schdulPrgrs) {
		this.schdulPrgrs = schdulPrgrs;
	}

	public String getSchdulPrgrsSttus() {
		return schdulPrgrsSttus;
	}

	public void setSchdulPrgrsSttus(String schdulPrgrsSttus) {
		this.schdulPrgrsSttus = schdulPrgrsSttus;
	}

	public String getSchdulFinDt() {
		return schdulFinDt;
	}

	public void setSchdulFinDt(String schdulFinDt) {
		this.schdulFinDt = schdulFinDt;
	}

	public String getSchdulLateReson() {
		return schdulLateReson;
	}

	public void setSchdulLateReson(String schdulLateReson) {
		this.schdulLateReson = schdulLateReson;
	}

	public String getSchdulType() {
		return schdulType;
	}

	public void setSchdulType(String schdulType) {
		this.schdulType = schdulType;
	}

	public int getSchdulTime() {
		return schdulTime;
	}

	public void setSchdulTime(int schdulTime) {
		this.schdulTime = schdulTime;
	}

	public int getSchdulEarlydelayTime() {
		return schdulEarlydelayTime;
	}

	public void setSchdulEarlydelayTime(int schdulEarlydelayTime) {
		this.schdulEarlydelayTime = schdulEarlydelayTime;
	}
