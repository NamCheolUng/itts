...
public class EgovIndvdlSchdulManageServiceImpl extends EgovAbstractServiceImpl implements EgovIndvdlSchdulManageService{
	...
	@Override
	public EgovMap selectIndvdlSchdulManageDetailEgovMap(IndvdlSchdulManageVO indvdlSchdulManageVO) throws Exception{
		return dao.selectIndvdlSchdulManageDetailEgovMap(indvdlSchdulManageVO);
	}
	...
	public void insertIndvdlSchdulManage(IndvdlSchdulManageVO indvdlSchdulManageVO) throws Exception {
		...
		if(indvdlSchdulManageVO.getNcrdId() != null && !indvdlSchdulManageVO.getNcrdId().isEmpty()){
			String [] ncrdIdL = indvdlSchdulManageVO.getNcrdId().split("//");
			for(int i=0;i<ncrdIdL.length;i++){
				if(ncrdIdL[i]!= null && !ncrdIdL[i].isEmpty()){
					IndvdlSchdulManageVO tmp = new IndvdlSchdulManageVO();
					tmp.setNcrdId(ncrdIdL[i]);
					tmp.setSchdulId(sMakeId);
					tmp.setTaskId(indvdlSchdulManageVO.getTaskId());					
					dao.insertRelatedCmng(tmp);
				}
			}
		}
	...
	public void updateIndvdlSchdulManage(IndvdlSchdulManageVO indvdlSchdulManageVO) throws Exception{
		...
		dao.deleteRelatedCmng(indvdlSchdulManageVO);
		if(indvdlSchdulManageVO.getNcrdId() != null && !indvdlSchdulManageVO.getNcrdId().isEmpty()){
			String [] ncrdIdL = indvdlSchdulManageVO.getNcrdId().split("//");			
			for(int i=0;i<ncrdIdL.length;i++){
				if(ncrdIdL[i]!= null && !ncrdIdL[i].isEmpty()){
					IndvdlSchdulManageVO tmp = new IndvdlSchdulManageVO();
					tmp.setNcrdId(ncrdIdL[i]);
					tmp.setSchdulId(indvdlSchdulManageVO.getSchdulId());
					tmp.setTaskId(indvdlSchdulManageVO.getTaskId());					
					dao.insertRelatedCmng(tmp);
				}
			}
	...
	@Override
	public void insertRelatedCmng(IndvdlSchdulManageVO indvdlSchdulManageVO)
			throws Exception {
		// TODO Auto-generated method stub
		dao.insertRelatedCmng(indvdlSchdulManageVO);
	}

	@Override
	public void deleteRelatedCmng(IndvdlSchdulManageVO indvdlSchdulManageVO)
			throws Exception {
		// TODO Auto-generated method stub
		dao.deleteRelatedCmng(indvdlSchdulManageVO);
	}
	...
	@Override
	public List<?> selectRelatedCmng(IndvdlSchdulManageVO indvdlSchdulManageVO)
			throws Exception {
		// TODO Auto-generated method stub
		return dao.selectRelatedCmng(indvdlSchdulManageVO);
	}
}
