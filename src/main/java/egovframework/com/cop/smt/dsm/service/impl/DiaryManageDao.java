...
public class DiaryManageDao extends EgovComAbstractDAO {
	...
	public List<?> selectDiarySection2or3 (ComDefaultVO comDefaultVO) throws Exception{
		 return list("DiaryManage.selectDiarySection2or3", comDefaultVO);
	}
	
	public List<?> selectDiaryCmng (DiaryManageVO diaryManageVO) throws Exception{
		 return list("DiaryManage.selectDiaryCmng", diaryManageVO);
	}
