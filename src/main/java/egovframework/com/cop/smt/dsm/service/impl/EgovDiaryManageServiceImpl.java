...
public class EgovDiaryManageServiceImpl extends EgovAbstractServiceImpl implements EgovDiaryManageService{
	...
	@Override
	public List<?> selectDiarySection2or3(ComDefaultVO searchVO)
			throws Exception {
		// TODO Auto-generated method stub
		return dao.selectDiarySection2or3(searchVO);
	}

	@Override
	public List<?> selectDiaryCmng(DiaryManageVO diaryManageVO)
			throws Exception {
		// TODO Auto-generated method stub
		return dao.selectDiaryCmng(diaryManageVO);
	}
}
