...
public class EgovAdressBookServiceImpl extends EgovAbstractServiceImpl implements EgovAdressBookService{
    ...
    public List<AdressBookUserVO> selectAdbkCodeList() throws Exception {
    	return (List<AdressBookUserVO>) adbkDAO.selectAdbkCodeList();
    }
    
    public String selectAdbkEntrprsSeCode(AdressBookVO adbVO) throws Exception {
    	return adbkDAO.selectAdbkEntrprsSeCode(adbVO);
    }
	...
	public void insertAdressBookUser(AdressBookUser abUser) throws Exception {
		// TODO Auto-generated method stub
		abUser.setAdbkId(idgenService.getNextStringId());
		adbkDAO.insertAdressBookUser(abUser);
	}
}
