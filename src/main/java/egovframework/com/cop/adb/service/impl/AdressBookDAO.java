...
public class AdressBookDAO extends EgovComAbstractDAO{
    ...
    public List<AdressBookUserVO> selectCompanyListist(AdressBookUserVO adressBookUserVO) throws Exception {
        return (List<AdressBookUserVO>) list("AdressBookDAO.selectCompanyListist", adressBookUserVO);
    }  
    
    public int selectCompanyLististCnt(AdressBookUserVO adressBookUserVO) throws Exception {
        return (int) select("AdressBookDAO.selectCompanyLististCnt", adressBookUserVO);
    }  
    
    public AdressBookUserVO selectUserDetail(AdressBookUserVO adressBookUserVO) throws Exception {
    	return  (AdressBookUserVO) select("AdressBookDAO.selectUserDetail", adressBookUserVO);
	}
    
    public void updateAdressBookUser(AdressBookUserVO adressBookUserVO) throws Exception {
    	update("AdressBookDAO.updateAdressBookUser", adressBookUserVO);
	}
    
    public List<?> selectAdbkCodeList() throws Exception {
        return list("AdressBookDAO.selectAdbkCodeList");
    }
    
    public String selectAdbkEntrprsSeCode(AdressBookVO adbVO) throws Exception {
        return (String) select("AdressBookDAO.selectAdbkEntrprsSeCode", adbVO);
    }
