...
public class NcrdManageDAO extends EgovComAbstractDAO {
    ...
    public List<NameCardVO> selectNcrdItemListOfUser(NameCardVO ncrdVO) throws Exception {
    	return (List<NameCardVO>) list("NcrdManageDAO.selectNcrdItemListOfUser", ncrdVO);
    ...
    public void updateAtchFileDetail(NameCardVO ncrdVO) throws Exception {
    	update("NcrdManageDAO.updateAtchFileDetail", ncrdVO);
    }
    ...
    public void updateNcrdFileId(NameCard nameCard) throws Exception {
    	update("NcrdManageDAO.updateNcrdFileId", nameCard);
        }
}
