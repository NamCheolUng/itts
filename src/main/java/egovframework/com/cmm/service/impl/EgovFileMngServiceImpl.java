...
public class EgovFileMngServiceImpl extends EgovAbstractServiceImpl implements EgovFileMngService {
	...
	public void updateFileInfsMobile(List<?> fvoList) throws Exception {
		//Delete & Insert
		fileMngDAO.updateFileInfsMobile(fvoList);
	}
