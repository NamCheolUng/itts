...
public class VcatnManageVO extends VcatnManage implements Serializable {
	...
	*/
	...
	//기본 연차
	private double baseOccrrncCo = 0.0;
	//생성일
	private String frstRegistPnttm;
	//업데이트일
	private String lastUpdtPnttm;
	//휴가차감일수
	private double vcatnCnt;
	//휴가총일수
	private double vcatnTotalcnt;
	...
	public double getBaseOccrrncCo() {
		return baseOccrrncCo;
	}
	public void setBaseOccrrncCo(double baseOccrrncCo) {
		this.baseOccrrncCo = baseOccrrncCo;
	}
	...
	public double getVcatnCnt() {
		return vcatnCnt;
	}
	public void setVcatnCnt(double vcatnCnt) {
		this.vcatnCnt = vcatnCnt;
	}
	public double getVcatnTotalcnt() {
		return vcatnTotalcnt;
	}
	public void setVcatnTotalcnt(double vcatnTotalcnt) {
		this.vcatnTotalcnt = vcatnTotalcnt;
	}
