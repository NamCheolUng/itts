...
public class EgovVcatnManageServiceImpl extends EgovAbstractServiceImpl implements EgovVcatnManageService {
	...
	public List<VcatnManageVO> selectVcatnDateList(TbAllvcatnmanageVO tbAllvcatnmanageVO) throws Exception {
		return vcatnManageDAO.selectVcatnDateList(tbAllvcatnmanageVO);
	}
	
	public List<VcatnManageVO> selectVcatnUserList(VcatnManageVO vcatnManageVO) throws Exception {
		return vcatnManageDAO.selectVcatnUserList(vcatnManageVO);
	}
	...
	public void insertVcatnManageAll(VcatnManage vcatnManage) throws Exception {
		vcatnManageDAO.insertVcatnManageAll(vcatnManage);
	}
	/**
	 * 휴가관리정보를 신규로 등록한다.
...
*/
	...
	public void updateAllVacationUse(VcatnManage vcatnManage) throws Exception {
		vcatnManageDAO.updateAllVacationUse(vcatnManage);
	}
	...
	public List<?> selectIndvdlYrycManageList(IndvdlYrycManage indvdlYrycManage) throws Exception {
		return vcatnManageDAO.selectIndvdlYrycManageList(indvdlYrycManage);
	}
	/**
	 * 개인별 연차를 수정 처리한다.
	 * @param vcatnManage - 휴가관리 model
