...
public class VcatnManageDAO extends EgovComAbstractDAO {
	...
	public List<VcatnManageVO> selectVcatnDateList(TbAllvcatnmanageVO tbAllvcatnmanageVO) throws Exception {
		return (List<VcatnManageVO>) list("vcatnManageDAO.selectVcatnDateList", tbAllvcatnmanageVO);
	}
	
	public List<VcatnManageVO> selectVcatnUserList(VcatnManageVO vcatnManageVO) throws Exception {
		return (List<VcatnManageVO>) list("vcatnManageDAO.selectVcatnUserList", vcatnManageVO);
	}
	...
	public void insertVcatnManageAll(VcatnManage vcatnManage) throws Exception {
		insert("vcatnManageDAO.insertVcatnManageAll", vcatnManage);
	}
	...
	public void updateAllVacationUse(VcatnManage vcatnManage) throws Exception {
		update("vcatnManageDAO.updateAllVacationUse", vcatnManage);
	}	
	...
	public List<?> selectIndvdlYrycManageList(IndvdlYrycManage indvdlYrycManage) throws Exception {
		return list("vcatnManageDAO.selectIndvdlYrycManageList", indvdlYrycManage);
	}
	...
	public void updateIndvdlYrycDeleteManage(IndvdlYrycManage indvdlYrycManage) throws Exception {
		   
		update("vcatnManageDAO.updateIndvdlYrycDeleteManage", indvdlYrycManage);
	}
	

	public void insertYearVacationCnt() throws Exception {
		insert("vcatnManageDAO.insertYearVacationCnt");
	}
	
	public void insertUserDefaultVacationCnt() throws Exception {
		insert("vcatnManageDAO.insertUserDefaultVacationCnt");
	}
	
	public void updateMonthVacationInc() throws Exception {
		update("vcatnManageDAO.updateMonthVacationInc");
	}	
	
	public List<IndvdlYrycManage> selectVacationYearList(IndvdlYrycManage indvdlYrycManage) throws Exception {
		return (List<IndvdlYrycManage>) list("vcatnManageDAO.selectVacationYearList", indvdlYrycManage);
	}

	public List<IndvdlYrycManage> selectVacationAllUserYearList() throws Exception {
		return (List<IndvdlYrycManage>) list("vcatnManageDAO.selectVacationAllUserYearList");
	}
